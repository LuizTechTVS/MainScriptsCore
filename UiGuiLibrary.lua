...
function library:CreateWindow(argstable)
...
local bind = argstable["Bind"]
    ...
    function window:CreateTab(argstable)
    ...
    local name = argstable["Name"]
        ...
        function tab:CreateSector(argstable)
        
        local name = argstable["Name"]
        local side = argstable["Side"]
            ...
            function sector:AddButton(argstable)
            
            local text = argstable["Name"]
            ...
            function sector:AddLabel(argstable)
            ...
            function sector:AddToggle(argstable)
            
            local text = argstable["Name"]
            local default = argstable["Default"]
            local callback = argstable["CallBack"]
            local flag = argstable["Flag"]
            ...
            function sector:AddTextbox(argstable)
            ...
            function sector:AddSlider(argstable)
            ...
            function sector:AddColorpicker(argstable)
            ...
            function sector:AddKeybind(argstable)
            ...
            function sector:AddDropdown(argstable)
            
            local text = argstable["Name"]
            local items = argstable["Items"]
            local default = argstable["ItemDefault"]
            local multichoice = argstable["MultiChoice"]
            local callback = argstable["CallBack"]
            ...
            function sector:AddSeperator(argstable)
